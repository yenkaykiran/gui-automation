sdGuiAutoApp.controller('BaseController', [ '$scope', '$rootScope', 'AjaxService', '$mdDialog', '$location', function($scope, $rootScope, AjaxService, $mdDialog, $location) {
    'use strict';
...
sdGuiAutoApp.controller('MenuController', function($scope) {
    'use strict';
});
