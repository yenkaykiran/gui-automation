...
public class StepsResourceImpl extends AbstractResourceImpl<Integer, SDTestStep, SDTestStepRepository, SDTestStepService> {
    ...
    @ResponseBody
    public ResponseEntity<List<SDTestStep>> reorder(@RequestBody List<HashMap<Integer, Integer>> order, @PathVariable("id") Integer id, HttpServletRequest httpRequest) {
        HttpHeaders headers = new HttpHeaders();
