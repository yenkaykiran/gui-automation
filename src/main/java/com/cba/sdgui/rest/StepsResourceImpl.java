...
public class StepsResourceImpl extends AbstractResourceImpl<Integer, SDTestStep, SDTestStepRepository, SDTestStepService> {
	...
	@ResponseBody
	public ResponseEntity<SDTestStep> saveStep(@RequestBody SDTestStep entity, @PathVariable("id") Integer id, HttpServletRequest httpRequest) {
	...
	@ResponseBody
	public ResponseEntity<List<SDTestStep>> runTest(@RequestBody List<HashMap<Integer, Integer>> order, @PathVariable("id") Integer id, HttpServletRequest httpRequest) {
		HttpHeaders headers = new HttpHeaders();
		HttpStatus responseStatus = null;
